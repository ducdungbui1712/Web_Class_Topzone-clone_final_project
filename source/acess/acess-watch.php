<?php
    ...
    $access = get_product_by_subCategory('phu kien apple watch');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section>
        <div class="filter-cate">
            <div class="ft-cate">
                ...
                <a href="../acess/acess-iphone.php" class> Phụ kiện Iphone</a>
                <a href="../acess/acess-mac.php" class> Phụ kiện Mac</a>
                <a href="../acess/acess-ipad.php" class> Phụ kiện Ipad</a>
                <a href="../acess/acess-watch.php" class="activate"> Phụ kiện Apple Watch</a>
