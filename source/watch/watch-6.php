<?php
    ...
    $watch = get_product_by_subCategory('Apple Watch Series 6');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section>
        <div class="filter-cate">
            <div class="ft-cate">
                ...
                <a href="../watch/watch-7.php" class> Apple Watch Series 7</a>
                <a href="../watch/watch-6.php" class="activate"> Apple Watch Series 6</a>
