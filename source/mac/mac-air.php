<?php
    ...
    $mac = get_product_by_subCategory('macbook air');
...
<head>
    ...
    <title>Macbook Pro chính hãng </title>
</head>
<style>
    *{
    ...
    <section>
        <div class="filter-cate">
            <div class="ft-cate">
                ...
                <a href="../mac/mac-air.php" class="activate"> Macbook Air</a>
                <a href="../mac/mac-mini.php" class> Mac Mini</a>
                <a href="../mac/imac.php" class> iMac</a>
            </div>
            <div class="ft-sort">
