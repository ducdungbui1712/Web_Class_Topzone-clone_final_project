<?php
    ...
    $iphone = get_product_by_subCategory('Iphone SE');
...
<head>
    ...
    <title>Điện thoại Iphone SE (mini, pro max)</title>
</head>
<style>
    *{
...
<body>
    <section>
        <div class="filter-cate">
            <div class="ft-cate">
                <a href="../iphone/iphone.php" class> Tất cả</a>
                ...
                <a href="../iphone/iphone-se.php" class="activate"> Iphone SE</a>
            </div>
            <div class="ft-sort">
